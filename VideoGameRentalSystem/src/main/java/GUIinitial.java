            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < Main.staffCounter + 1; i++) {
                    ...
                    if (tempUsername.equals(txtfldUsername.getText())) {
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Username already exists! try again."); 
                        flag1 = true;
                        break;
                    }
                }
                ...
                for (int i = 0; i < Main.staffCounter + 1; i++) {
                    ...
                    if (tempUsername.equals(txtfldUsername.getText())) {
                        if (tempPassword.equals(String.valueOf(passfldPassword.getPassword()))) {
                            JOptionPane.showMessageDialog(rootPane, "Login success! Welcome " + tempStaff.getStaffName());
                            flag1 = true;
                            break;
                        }
                    }                 
